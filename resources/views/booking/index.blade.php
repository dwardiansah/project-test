    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{ route('bookings.create') }}" class="btn btn-info btn-sm float-end">Tambah</a>
            </div>
            <div class="card-body">
                    ...
                    <tbody>
                        @foreach ($bookings as $index => $booking)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('bookings.show', $booking) }}" class="btn btn-info btn-sm">Lihat</a>
                                    <a href="{{ route('bookings.edit', $booking) }}" class="btn btn-warning btn-sm">Edit</a>
                                    <form action="{{ route('bookings.destroy', $booking) }}" method="POST" style="display:inline-block;" onsubmit="return confirm('Yakin hapus data?')">
                                        @csrf
                                        @method('DELETE')
