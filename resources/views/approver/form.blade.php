...
<div class="form-group mb-3">
    ...
    <select name="driver_id" class="form-control" disabled>
...
@if($booking->approver1_id == auth()->user()->id)
<div class="form-group mb-3">
    <label for="approver1_id">Approver 1</label>
    <select name="approver1_id" class="form-control" disabled>
...
@if($booking->approver2_id == auth()->user()->id)
<div class="form-group mb-3">
    <label for="approver2_id">Approver 2</label>
    <select name="approver2_id" class="form-control" disabled>
...
<div class="form-group mb-3">
    ...
    <input type="date" name="start_time" value="{{ old('start_time', $booking->start_time) }}" class="form-control" readonly>
</div>

<div class="form-group mb-3">
    <label for="end_time">End</label>
    <input type="date" name="end_time" value="{{ old('end_time', $booking->end_time) }}" class="form-control" readonly>
</div>
...
<div class="form-group mb-3">
    ...
    <select name="status" class="form-control" required>
        @if($booking->approver1_id == auth()->user()->id)
            <option value="approved_1" {{ old('status', $booking->status) == 'approved_1' ? 'selected' : '' }}>Approved</option>
        @endif
        @if($booking->approver2_id == auth()->user()->id)
            <option value="approved_2" {{ old('status', $booking->status) == 'approved_2' ? 'selected' : '' }}>Approved</option>
        @endif
